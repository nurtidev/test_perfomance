...
func (HealthCheckResponse_ServingStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_helth_proto_enumTypes[0].Descriptor()
}

func (HealthCheckResponse_ServingStatus) Type() protoreflect.EnumType {
	return &file_helth_proto_enumTypes[0]
}
...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_helth_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *HealthCheckRequest) Reset() {
	*x = HealthCheckRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_helth_proto_msgTypes[0]
...
func (*HealthCheckRequest) Descriptor() ([]byte, []int) {
	return file_helth_proto_rawDescGZIP(), []int{0}
}
...
func (x *HealthCheckResponse) Reset() {
	*x = HealthCheckResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_helth_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HealthCheckResponse) Descriptor() ([]byte, []int) {
	return file_helth_proto_rawDescGZIP(), []int{1}
}
...
var File_helth_proto protoreflect.FileDescriptor

var file_helth_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x68, 0x65, 0x6c, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x67,
	...
	0x30, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_helth_proto_rawDescOnce sync.Once
	file_helth_proto_rawDescData = file_helth_proto_rawDesc
)

func file_helth_proto_rawDescGZIP() []byte {
	file_helth_proto_rawDescOnce.Do(func() {
		file_helth_proto_rawDescData = protoimpl.X.CompressGZIP(file_helth_proto_rawDescData)
	})
	return file_helth_proto_rawDescData
}

var file_helth_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_helth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_helth_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: grpc.health.v1.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: grpc.health.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: grpc.health.v1.HealthCheckResponse
}
var file_helth_proto_depIdxs = []int32{
...
func init() { file_helth_proto_init() }
func file_helth_proto_init() {
	if File_helth_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_helth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_helth_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_helth_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_helth_proto_goTypes,
		DependencyIndexes: file_helth_proto_depIdxs,
		EnumInfos:         file_helth_proto_enumTypes,
		MessageInfos:      file_helth_proto_msgTypes,
	}.Build()
	File_helth_proto = out.File
	file_helth_proto_rawDesc = nil
	file_helth_proto_goTypes = nil
	file_helth_proto_depIdxs = nil
}
